...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.asTemplate = function () {
        var ref = this.modal.open(this.resultModal, {
            title: "abcd",
            size: "abc",
            modalClass: 'mymodal',
            hideCloseButton: false,
