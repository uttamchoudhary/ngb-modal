...
> Modal dialog for angular 6 applications using bootstrap. If used without bootstrap, please add appropriate styles for modal to work properly. Raise an issue on github if found any.
